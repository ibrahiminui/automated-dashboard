...
def create_or_update_dashboard(project_id, config_file, json_file_line, json_file_group, bucket_name, state_file):
    ...
    unique_state_file = f"{appcode}_{state_file}"
    dashboard_state = download_dashboard_state(bucket_name, unique_state_file)
    ...
    if dashboard_state:
        ...
        if existing_dashboard:
            ...
            upload_dashboard_state(bucket_name, unique_state_file, dashboard_state)
    else:
